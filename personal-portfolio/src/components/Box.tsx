...
function Box({ size }: { size: string }) {
  return (
    <div
      className={cn(
        `relative h-[calc(725px_/_1.6)] w-full cursor-pointer overflow-hidden rounded-4xl border-2 border-stone-900 p-11 text-lg shadow-button transition hover:-translate-x-1 hover:shadow-buttonHover sm:h-[calc(580px/_2)] sm:w-[calc(725px_/_2)] md:h-[calc(580px/_1.8)] md:w-[calc(725px_/_1.8)] lg:h-[calc(580px/_1.3)] lg:w-[calc(725px_/_1.3)] xl:h-[calc(580px_/_1.3)] xl:max-h-[calc(580px_/_1.3)] xl:w-[calc(725px_/_1.3)] xl:max-w-[calc(725px_/_1.3)]`,
      )}
    >
