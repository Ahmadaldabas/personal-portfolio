        ...
        >
          ...
          {!isLargeDevice && (
            <div className="mt-28 flex w-full max-w-full items-start justify-between text-start lg:hidden">
              <div
                ref={secContainerRef}
                className="grid grid-cols-[auto_,_minmax(0,_1fr)] items-center justify-items-center gap-x-[8.7rem] gap-y-36 sm:gap-x-48"
              >
              ...
              <div className="grid grid-cols-[minmax(0,_1fr)_,_auto] items-center justify-items-center gap-x-[8.7rem] gap-y-36 sm:gap-x-48">
                <div></div>
          ...
          {!isLargeDevice && (
            <>
              ...
              <div className="mt-28 flex w-full max-w-full items-start justify-between text-start lg:hidden">
                <div className="grid grid-cols-[auto_,_minmax(0,_1fr)] items-center justify-items-center gap-x-[8.7rem] gap-y-36 sm:gap-x-48">
                  <div className="flex w-10 max-w-10 flex-col items-start justify-between justify-self-start">
                    <Circle
                      ref={leftRef3}
                      className="b z-10 border border-stone-900 p-4 shadow-circle"
